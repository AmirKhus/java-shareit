...
public class ItemControllerTest {
    ...
    void addItem() throws Exception {
        when(itemService.create(any(ItemDto.class),anyLong())).thenReturn(firstitemDto);
        ...
        verify(itemService, times(1)).create(firstitemDto,1L);
    }
    ...
    void getSearchItem() throws Exception {
        when(itemService.search(anyString(), anyInt(), anyInt())).thenReturn(List.of(firstitemDto, secondItemDto));
        ...
        verify(itemService, times(1)).search("text", 0, 10);
    }
