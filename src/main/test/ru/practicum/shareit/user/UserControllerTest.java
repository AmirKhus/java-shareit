...
public class UserControllerTest {
    ...
    void addUser() throws Exception {
        when(userService.create(any(UserDto.class))).thenReturn(firstUserDto);
        ...
        verify(userService, times(1)).create(firstUserDto);
    }

    @Test
    void updateUser() throws Exception {
        when(userService.update(anyLong(),any(UserDto.class))).thenReturn(firstUserDto);
        ...
        verify(userService, times(1)).update(1L,firstUserDto);
    }
