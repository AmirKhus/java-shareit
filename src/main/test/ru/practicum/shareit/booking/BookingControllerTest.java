...
public class BookingControllerTest {
    ...
    void approveBooking() throws Exception {
        when(bookingService.confirmationBooking(anyLong(),anyLong(), anyBoolean())).thenReturn(firstBookingOutDto);
        ...
        verify(bookingService, times(1)).confirmationBooking(1L, 1L, true);
    }
    ...
    void getAllBookingsByBookerId() throws Exception {
        when(bookingService.getAllBrookingByBookerId(anyLong(), anyString(), anyInt(), anyInt())).thenReturn(List.of(firstBookingOutDto, secondBookingOutDto));
        ...
        verify(bookingService, times(1)).getAllBrookingByBookerId(1L, "ALL", 0, 10);
    }
